package com.example.ecommerce.user.security.services;

import com.example.ecommerce.user.security.models.AuthorizationConsent;
import com.example.ecommerce.user.security.repository.AuthorizationConsentRepository;
